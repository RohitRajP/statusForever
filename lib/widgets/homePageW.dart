...
Widget appBarW(appBarMessage, context, fetchStatuses,setRefreshValue) {
  return AppBar(
    ...
    child: RichText(
        ...
        text: TextSpan(
            ...
            children: [
              ...
              TextSpan(
                  text: 'to save and serve statuses and ',
                  style: message_textStyle),
              TextSpan(
                  text: 'contacts permission ', style: permission_textStyle),
              TextSpan(
                  text: 'to help you categorize them ',
                  style: message_textStyle),
            ])),
  );
}
...
Widget imageView(index, _fileList, showOptions) {
  return GestureDetector(
    ...
    child: ClipRRect(
      ...
      child: Image.file(
        File(
            "/storage/emulated/0/WhatsApp/Media/.Statuses/" + _fileList[index]),
        fit: BoxFit.cover,
      ),
    ),
  );
